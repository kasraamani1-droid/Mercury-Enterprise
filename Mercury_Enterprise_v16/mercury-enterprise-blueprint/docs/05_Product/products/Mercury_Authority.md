...
Mercury Authority is an oversight experience for aviation authorities and accountable managers who must review evidence. It does not make Mercury a certified authority system; it supports operator-presented auditability.

---

## 2. Positioning

Mercury Authority is a named commercial and architectural product within the Mercury Aviation Enterprise Operating System. It does not ship a separate database or a divergent security model. It packages capabilities on **Mercury Core** so buyers recognize their operating role while the **Digital Thread** remains continuous.

---

## 3. Target users

- Authority inspectors (customer-authorized access)
...
| Capability | Status |
|------------|--------|
| Immutable audit and exportable history | Delivered foundation |
| Authority portal UX / case files | Planned |

---

## 5. Major entities

AuditEvent, CertificationSignature, PublicationRevision, Passport export packs (target).
...
Audit APIs today; future `/api/v1/authority/*` with explicit grants.
...
Core, Passport, Certification Workflow, Authority Integration standards.

---

## 11. Roadmap

Read-only oversight spaces; evidence packages; never silent cross-tenant access.
