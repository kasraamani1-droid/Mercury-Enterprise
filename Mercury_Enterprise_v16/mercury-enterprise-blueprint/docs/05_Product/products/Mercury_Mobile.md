...
Mercury Mobile brings hangar and line workflows to handheld devices: job cards, material requests, scan/RFID, tool issue — consuming the same APIs as desktop.

---

## 2. Positioning

Mercury Mobile is a named commercial and architectural product within the Mercury Aviation Enterprise Operating System. It does not ship a separate database or a divergent security model. It packages capabilities on **Mercury Core** so buyers recognize their operating role while the **Digital Thread** remains continuous.
...
|------------|--------|
| Scan API | Delivered |
| Offline queue patterns (desktop) | Partial |
| Native/PWA mobile client | Planned |

---

## 5. Major entities

Uses JobCard, MaterialRequest, ToolIssue, PartIdentifier.
...
`/api/v1/logistics/scan`, work-order and logistics mutation APIs.
...
Core, MRO, logistics; UI Standards for offline honesty.

---

## 11. Roadmap

PWA first; barcode/RFID; optional offline with conflict rules.
