...
Mercury Connect is the integration hub: connectors, health, and eventually event delivery to OCC, ERP, PLM, and partner systems.

---

## 2. Positioning

Mercury Connect is a named commercial and architectural product within the Mercury Aviation Enterprise Operating System. It does not ship a separate database or a divergent security model. It packages capabilities on **Mercury Core** so buyers recognize their operating role while the **Digital Thread** remains continuous.
...
| Capability | Status |
|------------|--------|
| Connector manager foundation | Partial |
| Event bus / webhooks at scale | Planned |
| Certified partner adapters | Planned |

---

## 5. Major entities

Connector, ConnectorState, DeliveryAttempt (target).
...
`/api/v1` connectors/ops surfaces today; future Connect control plane.
...
Core, Developer Platform, Plugin Architecture.

---

## 11. Roadmap

Outbound webhooks; idempotent ingest; partner certification program.
