# ADR-0002 — One Digital Thread, one Digital Aircraft Passport
...
| Canonical slug | `ADR-0002-digital-thread-passport.md` |
| Legacy slug | `ADR-0002-digital-thread-as-spine.md` (same decision) |
| Supersedes | — |
| Superseded by | — |
