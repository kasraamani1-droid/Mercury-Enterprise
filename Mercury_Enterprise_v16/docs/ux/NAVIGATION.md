...
- Cross-module: Aircraft → Work Order → Job Card → Materials (MR) → Logistics part/PO; Planning due/check/AD/finding → generate WP → Work Order → Aircraft → Configuration. Area tabs stay open; `data-we-tab` selects an object tab without resetting unrelated sessions.
