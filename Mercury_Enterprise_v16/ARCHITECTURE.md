...
- **Maintenance planning:** Programs/revisions, MPD, checks, AD/SB/EO, MEL/CDL, deferred defects, utilization, forecast/due list, hangar/parts/tool/workforce plan lines, automatic work-package generation into Sprint 8 execution (see [docs/MAINTENANCE_PROGRAM.md](docs/MAINTENANCE_PROGRAM.md), [docs/FORECAST_ENGINE.md](docs/FORECAST_ENGINE.md))
